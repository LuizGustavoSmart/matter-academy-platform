import { BookOpen, Layers, ClipboardList, HelpCircle, MessageSquare, LayoutDashboard } from 'lucide-react';
...
export default function StudentLayout() {
  ...
  const nav: NavGroup[] = [
    {
      items: [
        { to: '/dashboard', label: isStaff ? 'Visão geral' : 'Aulas', icon: isStaff ? LayoutDashboard : BookOpen, match: (p) => p === '/dashboard' || (!isStaff && p.startsWith('/curso/')) },
