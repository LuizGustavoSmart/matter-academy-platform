-- Link da aula ao vivo (único por curso, reutilizado em todas as aulas)
ALTER TABLE public.cursos ADD COLUMN IF NOT EXISTS link_ao_vivo text;

-- Agenda de datas/horários das aulas, por turma (a mesma aula/curso pode
-- ter horários diferentes em turmas diferentes)
