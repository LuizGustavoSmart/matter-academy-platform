-- Campo de texto opcional no envio de atividade (além do anexo, também opcional)
ALTER TABLE public.atividade_envios ADD COLUMN IF NOT EXISTS texto text;

-- Comunidade em formato de chat, uma por turma+curso (mesma granularidade das atividades)
