-- Permite que um perfil "professor"/"monitor" seja staff em algumas turmas e
-- aluno normal em outras — mesmo padrão já usado para `is_embaixador`.
-- Sem essa coluna, is_professor_of_turma() concedia acesso de staff a QUALQUER
-- turma em que o profissional tivesse uma linha em user_turmas, bastando o role.
