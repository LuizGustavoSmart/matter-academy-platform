-- Imagens-modelo de capa de turma, reaproveitadas ao criar/editar uma
-- turma — mesmo padrão de faixa_capas, mas com um valor fixo por tipo de
-- turma em vez de por faixa: "TD Matter" e "Padrão" (demais turmas).
