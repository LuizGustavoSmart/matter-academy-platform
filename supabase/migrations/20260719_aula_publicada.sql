-- Controle de visibilidade da aula para os alunos (on/off).
-- Aulas já existentes continuam visíveis (true); novas aulas começam
-- ocultas por padrão até o admin ativar.
...
-- Alunos só veem aulas publicadas; admin continua vendo todas
